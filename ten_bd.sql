...
TRUNCATE TABLE dbo.Criticas
INSERT INTO dbo.Criticas (VideoId, Critica, Classificacao) VALUES 
...
TRUNCATE TABLE dbo.Utilizadores
INSERT INTO dbo.Utilizadores (Nome, Email, Password, Tipo, Descricao, Linkedin, Telefone) VALUES
...
TRUNCATE TABLE dbo.LinksVideos
INSERT INTO dbo.LinksVideos (Titulo, Link, Tags, Descricao, UtilizadorId) VALUES
...
ALTER TABLE Criticas
    ADD CONSTRAINT fk_critica
        FOREIGN KEY (VideoId)
            REFERENCES LinksVideos (Id)
            ON DELETE CASCADE;

ALTER TABLE LinksVideos
    ADD CONSTRAINT fk_linkvideo
